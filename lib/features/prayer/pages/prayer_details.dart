...
class PrayerDetails extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final prayer = ModalRoute.settingsOf(context)?.arguments as PrayerModel;
          ...
          return Scaffold(
              ...
              body: ReadWidgets(
                ...
                child: TabBarView(controller: tabController, children: [
                  Declaration(content: prayer.prayer, isTablet: isTablet),
                  const Center(
